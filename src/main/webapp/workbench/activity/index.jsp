...
<script type="text/javascript" src="jquery/bootstrap_3.3.0/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="jquery/moment/moment.min.js"></script>
	<script type="text/javascript" src="jquery/moment/moment-with-locales.min.js"></script>
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/js/bootstrap-datetimepicker.js" ></script>
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js" charset="GBK"></script>
	<link rel="stylesheet" type="text/css" href="jquery/bs_pagination/jquery.bs_pagination.min.css">
	<script  src="jquery/bs_pagination/jquery.bs_pagination.min.js" ></script>
	<script  src="jquery/bs_pagination/en.js" charset="GBK" ></script>
			...
			//肯定只选了一条
				...
				$.ajax({
					...
					success : function (data) {
						...
						//处理单条activity
						$("#edit-id").val(data.activityById.id);
						$("#edit-name").val(data.activityById.name);
						$("#edit-owner").val(data.activityById.owner);
						$("#edit-startDate").val(data.activityById.startDate);
						$("#edit-endDate").val(data.activityById.endDate);
						$("#edit-cost").val(data.activityById.cost);
						$("#edit-description").val(data.activityById.description);
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							<%--@declare id="edit-marketactivityowner"--%><%--@declare id="edit-marketactivityname"--%><label for="edit-marketActivityOwner" class="col-sm-2 control-label">所有者<span style="font-size: 15px; color: red;">*</span></label>
						...
						<div class="form-group">
							<%--@declare id="edit-starttime"--%><%--@declare id="edit-endtime"--%><label for="edit-startTime" class="col-sm-2 control-label">开始日期</label>
							<div class="col-sm-10" style="width: 300px;">
						...
						<div class="form-group">
							<%--@declare id="edit-describe"--%><label for="edit-describe" class="col-sm-2 control-label">描述</label>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form id="activityAddForm" class="form-horizontal" role="form">
						...
						<div class="form-group">
							<%--@declare id="create-marketactivityowner"--%><%--@declare id="create-marketactivityname"--%><label for="create-marketActivityOwner" class="col-sm-2 control-label">所有者<span style="font-size: 15px; color: red;">*</span></label>
							<div class="col-sm-10" style="width: 300px;">
						...
						<div class="form-group">
							<%--@declare id="create-starttime"--%><%--@declare id="create-endtime"--%><label for="create-startTime" class="col-sm-2 control-label">开始日期</label>
							<div class="col-sm-10" style="width: 300px;">
						...
						<div class="form-group">
							<%--@declare id="create-describe"--%><label for="create-describe" class="col-sm-2 control-label">描述</label>
							<div class="col-sm-10" style="width: 81%;">
